...
export default function ClientPersonalTrainingPage() {
  ...
  return (
    <div className="space-y-4">
      <h2 className="text-xl font-semibold">Персональные тренировки</h2>
            ...
            <div className="space-y-3">
              ...
              {loadingSlots ? (
                ...
                <ul className="space-y-2">
                  {slots.map((slot) => (
                    <li key={slot.startAt} className="card flex items-center justify-between gap-3">
                      <div>
