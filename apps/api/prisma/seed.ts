...
const DEMO_USERS = [
  ...
  },
  {
    ...
    employeeCode: '000000169',
    dateOfBirth: new Date('2003-11-05'),
    gender: Gender.FEMALE,
    roles: [Role.TRAINER],
  },
  {
    email: '000000173@staff.fitgo.local',
    password: randomBytes(24).toString('hex'),
    firstName: 'Наталья',
    lastName: 'Белевич',
    phone: '',
    employeeCode: '000000173',
  ...
  {
    email: '000000091@staff.fitgo.local',
    password: randomBytes(24).toString('hex'),
    firstName: 'Екатерина',
    lastName: 'Шиманская',
    phone: '',
    employeeCode: '000000091',
    gender: Gender.FEMALE,
    loginEnabled: false,
    roles: [Role.TRAINER],
  },
  {
    email: '000000136@staff.fitgo.local',
    password: randomBytes(24).toString('hex'),
    firstName: 'Юлия Александровна',
    lastName: 'Бледнова',
    phone: '',
    employeeCode: '000000136',
    dateOfBirth: new Date('1983-07-06'),
    gender: Gender.FEMALE,
    loginEnabled: false,
    roles: [Role.TRAINER],
  },
  {
    email: '000000156@staff.fitgo.local',
    password: randomBytes(24).toString('hex'),
    firstName: 'Ирина Александровна',
    lastName: 'Доминецкая',
    phone: '',
    employeeCode: '000000156',
  ...
  {
    email: '000000158@staff.fitgo.local',
    password: randomBytes(24).toString('hex'),
    firstName: 'Данила Олегович',
    lastName: 'Рогач',
    phone: '',
    employeeCode: '000000158',
    dateOfBirth: new Date('2004-10-02'),
    gender: Gender.MALE,
    loginEnabled: false,
    roles: [Role.TRAINER],
  },
  {
    email: '000000163@staff.fitgo.local',
    password: randomBytes(24).toString('hex'),
    firstName: 'Мария Николаевна',
    lastName: 'Аниковец',
    phone: '',
    employeeCode: '000000163',
  ...
  {
    email: '000000174@staff.fitgo.local',
    password: randomBytes(24).toString('hex'),
    firstName: 'Владислав Денисович',
    lastName: 'Матушевский',
    phone: '',
    employeeCode: '000000174',
  ...
  {
    email: '000000176@staff.fitgo.local',
    password: randomBytes(24).toString('hex'),
    firstName: 'Виктория Михайловна',
    lastName: 'Баскакова',
    phone: '',
    employeeCode: '000000176',
  ...
  {
    email: '000000177@staff.fitgo.local',
    password: randomBytes(24).toString('hex'),
    firstName: 'Александр Николаевич',
    lastName: 'Кныш',
    phone: '',
    employeeCode: '000000177',
    dateOfBirth: new Date('1989-06-11'),
    gender: Gender.MALE,
    loginEnabled: false,
    roles: [Role.TRAINER],
  },
  ...
  {
    email: 'tech@demo.fitgo',
    password: 'tech12345',
    firstName: 'Игорь',
    lastName: 'Техников',
    phone: '+375297770011',
    externalId: '1c-tech-001',
    loginEnabled: false,
    roles: [Role.TECH],
  },
  {
    ...
    employeeCode: '000000151',
    dateOfBirth: new Date('1999-11-24'),
    roles: [Role.ADMIN],
    withAllAdminPermissions: true,
  },
  {
    email: '000000168@staff.fitgo.local',
    password: randomBytes(24).toString('hex'),
    firstName: 'Полина Ивановна',
    lastName: 'Дашук',
    phone: '',
    employeeCode: '000000168',
    loginEnabled: false,
    roles: [Role.ADMIN],
    withAllAdminPermissions: true,
  },
  {
    email: '000000171@staff.fitgo.local',
    password: randomBytes(24).toString('hex'),
    firstName: 'Ульяна Денисовна',
    lastName: 'Гилева',
    phone: '',
    employeeCode: '000000171',
    dateOfBirth: new Date('2005-03-29'),
    loginEnabled: false,
    roles: [Role.ADMIN],
    withAllAdminPermissions: true,
  },
  {
    email: '000000175@staff.fitgo.local',
    password: randomBytes(24).toString('hex'),
    firstName: 'Илона Ильинична',
    lastName: 'Гордеюк',
    phone: '',
    employeeCode: '000000175',
    loginEnabled: false,
    roles: [Role.ADMIN],
    withAllAdminPermissions: true,
  },
  ...
  for (const demoUser of DEMO_USERS) {
    ...
    const user = await prisma.user.upsert({
      ...
      update: {
        ...
        phoneNormalized: demoUser.phone ? normalizePhone(demoUser.phone) : null,
        externalId: demoUser.externalId,
        password: passwordHash,
        clubId: club.id,
        ...('employeeCode' in demoUser && demoUser.employeeCode
          ? { employeeCode: demoUser.employeeCode }
          : {}),
        ...('loginEnabled' in demoUser
          ? { loginEnabled: demoUser.loginEnabled }
          : {}),
        ...('dateOfBirth' in demoUser && demoUser.dateOfBirth
